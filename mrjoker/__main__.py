...
MRJOKER_IMG = "https://telegra.ph/file/a743258a2c2803b8a710a.jpg"

MRJOKER_AUD = "https://t.me/NOINOIBOTM/2"


PM_START_TEXT = """
*Hello there*, *I*'*m* [R E C K L E S S](https://telegra.ph/file/a743258a2c2803b8a710a.jpg)
...
buttons = [
   ...
   # [
    ...
    [
        InlineKeyboardButton(text="➕ 𝗔𝗗𝗗 𝗥𝗘𝗖𝗞𝗟𝗘𝗦𝗦 𝗧𝗢 𝗬𝗢𝗨𝗥 𝗚𝗥𝗢𝗨𝗣 ➕", url="http://t.me/Mrjokerlk_bot?startgroup=true"),
    ],
]
...
HELP_STRINGS = """
**SETTINGS**
**𝐂𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐝𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐚𝐛𝐨𝐮𝐭 𝐬𝐩𝐞𝐜𝐢𝐟𝐢𝐜 𝐦𝐨𝐝𝐮𝐥𝐞𝐬**[🤖](https://telegra.ph/file/a743258a2c2803b8a710a.jpg)"""
...
def mrjoker_about_callback(update, context):
    ...
    if query.data == "mrjoker_":
        query.message.edit_text(
            ...
            text=f"*😈 Hi again!  The name's {dispatcher.bot.first_name} 😈 \n\nAs  You I'm a next generational group management bot developed by [bazigar](https://t.me/bazigaryt) .* "
            f"\n\n 🔥 Join [bazigar](https://t.me/bazigaryt) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/a743258a2c2803b8a710a.jpg)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/phoenix_empire"
                        ),
                        InlineKeyboardButton(
                            text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧", url="https://t.me/cfc_bot_support"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, R E C K L E S S now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="* R E C K L E S S support chats*"
            "\nJoin Support Group/Channel",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/phoenix_empire"),
                 ],
                 [
                    InlineKeyboardButton(text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 👥", url= "https://t.me/cfc_bot_support"),
                 ],
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR R E C K L E S S DEV'S</b>\n"
            f"\nHere Some Developers Helping in Making The Mr.Joker Bot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝗕𝗔𝗭𝗜𝗚𝗔𝗥🔥", url="t.me/bazigaryt"),
                    InlineKeyboardButton(text="𝗛𝗘𝗬𝗔𝗠𝗔𝗡🔥", url="t.me/heyaaman"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😈 I'm *R E C K L E S S*
                 \nHere is the [😈𝗖𝗙𝗖 𝗡𝗘𝗧𝗪𝗢𝗥𝗞😈](https://t.me/cfc_hub) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
