...
# from mrjoker.modules.sql import cust_filters_sql as filtersql
...
from mrjoker import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @hitechlkgroup"
            )
...
def export_data(update, context):
    ...
    f = open("Mr_Joker{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Mr_Joker{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MrJoker-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Mr_Joker{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 🔹 `/import`: Reply to the backup file for the butler / Mr.Joker group to import as much as possible, making transfers very easy! \
